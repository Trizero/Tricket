...
abstract class BaseTicketPeer {
	...
	const CLASS_DEFAULT = 'Tricket.Ticket';
	...
	const AREA_ID = 'Ticket.AREA_ID';

	/** the column name for the CLIENTE_ID field */
	const CLIENTE_ID = 'Ticket.CLIENTE_ID';

	/** the column name for the NOMEREFERENTE field */
	const NOMEREFERENTE = 'Ticket.NOMEREFERENTE';

	/** the column name for the EMAILRIFERIMENTO field */
	const EMAILRIFERIMENTO = 'Ticket.EMAILRIFERIMENTO';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'AreaId', 'ClienteId', 'Nomereferente', 'Emailriferimento', 'Stato', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'areaId', 'clienteId', 'nomereferente', 'emailriferimento', 'stato', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::AREA_ID, self::CLIENTE_ID, self::NOMEREFERENTE, self::EMAILRIFERIMENTO, self::STATO, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'AREA_ID', 'CLIENTE_ID', 'NOMEREFERENTE', 'EMAILRIFERIMENTO', 'STATO', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'Area_id', 'Cliente_id', 'nomeReferente', 'emailRiferimento', 'stato', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'AreaId' => 1, 'ClienteId' => 2, 'Nomereferente' => 3, 'Emailriferimento' => 4, 'Stato' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'areaId' => 1, 'clienteId' => 2, 'nomereferente' => 3, 'emailriferimento' => 4, 'stato' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::AREA_ID => 1, self::CLIENTE_ID => 2, self::NOMEREFERENTE => 3, self::EMAILRIFERIMENTO => 4, self::STATO => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'AREA_ID' => 1, 'CLIENTE_ID' => 2, 'NOMEREFERENTE' => 3, 'EMAILRIFERIMENTO' => 4, 'STATO' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'Area_id' => 1, 'Cliente_id' => 2, 'nomeReferente' => 3, 'emailRiferimento' => 4, 'stato' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(TicketPeer::AREA_ID);
			$criteria->addSelectColumn(TicketPeer::CLIENTE_ID);
			$criteria->addSelectColumn(TicketPeer::NOMEREFERENTE);
			$criteria->addSelectColumn(TicketPeer::EMAILRIFERIMENTO);
			$criteria->addSelectColumn(TicketPeer::STATO);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.AREA_ID');
			$criteria->addSelectColumn($alias . '.CLIENTE_ID');
			$criteria->addSelectColumn($alias . '.NOMEREFERENTE');
			$criteria->addSelectColumn($alias . '.EMAILRIFERIMENTO');
	...
	public static function doCountJoinCliente(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(TicketPeer::CLIENTE_ID, ClientePeer::ID, $join_behavior);
	...
	public static function doCountJoinArea(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(TicketPeer::AREA_ID, AreaPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Ticket objects pre-filled with their Area objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Ticket objects.
	...
	public static function doSelectJoinArea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Ticket) to $obj2 (Area)
				$obj2->addTicket($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Ticket) to the collection in $obj3 (Area)
				$obj3->addTicket($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of Ticket objects pre-filled with all related objects except Cliente.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptCliente(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = TicketPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Ticket) to the collection in $obj2 (Area)
				$obj2->addTicket($obj1);
	...
	/**
	 * Selects a collection of Ticket objects pre-filled with all related objects except Area.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
