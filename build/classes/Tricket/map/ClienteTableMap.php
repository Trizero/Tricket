...
class ClienteTableMap extends TableMap
{
	 ...
	 */
	const CLASS_NAME = 'Tricket.map.ClienteTableMap';
	...
	{
		$this->addRelation('Ticket', 'Ticket', RelationMap::ONE_TO_MANY, array('id' => 'Cliente_id', ), null, null);
		$this->addRelation('Areacliente', 'Areacliente', RelationMap::ONE_TO_MANY, array('id' => 'Cliente_id', ), null, null);
	} // buildRelations()
