...
abstract class BaseAreaPeer {
	...
	const CLASS_DEFAULT = 'Tricket.Area';
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(AreaPeer::NOME);
		} else {
	 ...
	 *
	 * @param      Area $value A Area object.
	...
	{
		return $withPrefix ? AreaPeer::CLASS_DEFAULT : AreaPeer::OM_CLASS;
	}
